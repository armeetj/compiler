...
let replace_vars (i : instr) dict : instr =
  match i with
  | Addq (a1, a2) -> Addq (replace_arg a1 dict, replace_arg a2 dict)
  | Subq (a1, a2) -> Subq (replace_arg a1 dict, replace_arg a2 dict)
  | Negq a -> Negq (replace_arg a dict)
  | Movq (a1, a2) -> Movq (replace_arg a1 dict, replace_arg a2 dict)
  | Pushq a -> Pushq (replace_arg a dict)
  | Popq a -> Popq (replace_arg a dict)
  | Callq (l, v) -> Callq (l, v)
  | Retq -> Retq
  | Jmp l -> Jmp l
