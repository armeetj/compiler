...
let adjust_stack_access instr deref_adjust =
  ...
  | X.Subq (a1, a2) ->
      Subq
        ...
        , offset (convert_arg a2) deref_adjust )
  | X.Negq a ->
      Negq (offset (convert_arg a) deref_adjust)
  | X.Xorq (a1, a2) ->
      Xorq
        ( offset (convert_arg a1) deref_adjust
        , offset (convert_arg a2) deref_adjust )
  | X.Cmpq (a1, a2) ->
      Cmpq
        ...
        , offset (convert_arg a2) deref_adjust )
  | X.Set (cc, a) ->
      Set (cc, offset (convert_arg a) deref_adjust)
  | X.Movq (a1, a2) ->
      Movq
        ( offset (convert_arg a1) deref_adjust
        , offset (convert_arg a2) deref_adjust )
  | X.Movzbq (a1, a2) ->
      Movzbq
        ...
        , offset (convert_arg a2) deref_adjust )
  | X.Pushq a ->
      Pushq (offset (convert_arg a) deref_adjust)
  | X.Popq a ->
      Popq (offset (convert_arg a) deref_adjust)
  | X.Callq (l, _) ->
      Callq l
  | X.Retq ->
      Retq
