...
let adjust_stack_access instr deref_adjust =
  ...
  | X.Xorq (a1, a2) -> Xorq (offset (convert_arg a1) deref_adjust, offset (convert_arg a2) deref_adjust)
  | X.Cmpq (a1, a2) -> Cmpq (offset (convert_arg a1) deref_adjust, offset (convert_arg a2) deref_adjust)
  ...
  | X.Movzbq (a1, a2) -> Movzbq (offset (convert_arg a1) deref_adjust, offset (convert_arg a2) deref_adjust)
