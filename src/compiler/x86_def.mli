...
(** Functions. *)
type fun_contents =
  {nparams : int; locals : (var * ty) list; body : (label * block) list}
[@@deriving sexp]
...
type finfo =
  | Finfo of {num_spilled : int; num_spilled_root : int; used_callee : RegSet.t}
[@@deriving sexp]

(** Definitions. *)
type def = Def of label * finfo * fun_contents [@@deriving sexp]

(** Programs. *)
type program = X86Program of def list [@@deriving sexp]
