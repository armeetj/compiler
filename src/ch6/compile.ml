...
let x86_var_global1_in =
  X86_var_global.program_of_sexp X86_var_global.info1_of_sexp
    X86_var_global.binfo1_of_sexp

let x86_var_global2_in =
  X86_var_global.program_of_sexp X86_var_global.info1_of_sexp
    X86_var_global.binfo2_of_sexp

let x86_var_global3_in =
  X86_var_global.program_of_sexp X86_var_global.info2_of_sexp
    X86_var_global.binfo1_of_sexp

let x86_var_global4_in =
  X86_var_global.program_of_sexp X86_var_global.info3_of_sexp
    X86_var_global.binfo1_of_sexp
...
let x86_var_global1_out =
  X86_var_global.sexp_of_program X86_var_global.sexp_of_info1
    X86_var_global.sexp_of_binfo1

let x86_var_global2_out =
  X86_var_global.sexp_of_program X86_var_global.sexp_of_info1
    X86_var_global.sexp_of_binfo2

let x86_var_global3_out =
  X86_var_global.sexp_of_program X86_var_global.sexp_of_info2
    X86_var_global.sexp_of_binfo1

let x86_var_global4_out =
  X86_var_global.sexp_of_program X86_var_global.sexp_of_info3
    X86_var_global.sexp_of_binfo1
...
let eval_alist =
  [
    ...
    ( "rc",
      fun exp -> exp |> tc1 |> sh |> un |> ea |> ug |> rc |> lalloc_mon_eval );
    ( "ec",
      fun exp -> exp |> tc1 |> sh |> un |> ea |> ug |> rc |> ec |> ctup_eval );
    ( "tc2",
      fun exp ->
...
let pass_alist =
  [
    ...
    ("rc", fun exp -> exp |> tc1 |> sh |> un |> ea |> ug |> rc |> lalloc_mon_out);
    ("ec", fun exp -> exp |> tc1 |> sh |> un |> ea |> ug |> rc |> ec |> ctup_out);
    ( "tc2",
      fun exp ->
    ...
    ( "bi",
      fun exp ->
        exp |> tc1 |> sh |> un |> ea |> ug |> rc |> ec |> tc2 |> ru |> si |> ul
        |> bi |> x86_var_global3_out );
    ( "ar",
      fun exp ->
        exp |> tc1 |> sh |> un |> ea |> ug |> rc |> ec |> tc2 |> ru |> si |> ul
        |> bi |> ar |> x86_var_global4_out );
    ( "rj",
      fun exp ->
        exp |> tc1 |> sh |> un |> ea |> ug |> rc |> ec |> tc2 |> ru |> si |> ul
        |> bi |> ar |> rj |> x86_var_global4_out );
    ( "pi",
      fun exp ->
        exp |> tc1 |> sh |> un |> ea |> ug |> rc |> ec |> tc2 |> ru |> si |> ul
        |> bi |> ar |> rj |> pi |> x86_global_out );
    ( "pc",
      fun exp ->
        exp |> tc1 |> sh |> un |> ea |> ug |> rc |> ec |> tc2 |> ru |> si |> ul
        |> bi |> ar |> rj |> pi |> pc |> x86_asm_out );
  ]
